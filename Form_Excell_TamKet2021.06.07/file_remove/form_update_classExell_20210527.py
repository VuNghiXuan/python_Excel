...
def show_form():
    class formExcel(Frame):
        ...
        def placeGui(obj, event):
            ...
            obj.posX_lbTieudeSeach = obj.posX_bntXoa + obj.W_bntXoa  + 20*obj.tab_X
            obj.posY_lbTieudeSeach = obj.posY_lbTieudelistbox
            ...
            obj.posX_entrySeach = obj.posX_lbTieudeSeach + obj.W_lbTieudeSeach + 3*obj.tab_X
